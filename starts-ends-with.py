...
print(f"\n{string} termina con la subcadena sola, desde la posición 100 hasta la posición 100: {resultado}")


resultado = string.endswith("s", -4, -2)
print(f"\n{string} termina con la subcadena sola, desde la posición -4 hasta la posición -2: {resultado}")
